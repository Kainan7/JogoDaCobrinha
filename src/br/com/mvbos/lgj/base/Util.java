...
public class Util {
	...
	public static boolean SXD(Elemento e, int largura, int altura){
		if (e.getPx()+e.getAltura()>altura){
			return true;
		}
		return false;
	}

	public static boolean SYB(Elemento e, int largura, int altura){
		if (e.getPy()+e.getAltura()>altura){
			return true;
		}
		return false;
	}

	public static boolean SXE(Elemento e, int largura, int altura){
		if (e.getPx()<0){
			return true;
		}
		return false;
	...
	public static boolean SYC(Elemento e, int largura, int altura){
		if (e.getPy()<0){
			return true;
		}
		return false;
